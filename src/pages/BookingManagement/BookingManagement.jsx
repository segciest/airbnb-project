...
const BookingManagement = () => {
    ...
    return (
      <div>
        <div className='mx-1'>
            Dasboard <i style={{color: '#F08080'}} className="fa-solid fa-arrow-right"></i><span style={{color: '#F08080'}}> Quản lý Đặt phòng </span>
          </div>
      <div className='flex justify-between'>
        <Button style={{backgroundColor:'#F08080', marginTop:'20px'}} onClick={showModal}><i className="fa-solid fa-money-check-dollar"></i>
