...
export const http = axios.create({
  ...
  headers: {
    ...
    token:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEiLCJlbWFpbCI6ImFkbWluQGdtYWlsLmNvbSIsInJvbGUiOiJBRE1JTiIsIm5iZiI6MTcxODUxNjM4MSwiZXhwIjoxNzE5MTIxMTgxfQ.PBPbzfK1LeVDP-ryBnRWY2aVtmkWWSfa8U_ppBEkuuE',
  },
  timeout: 30000,
});
